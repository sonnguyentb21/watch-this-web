...
var init__ = __esm({
  ".svelte-kit/output/server/nodes/0.js"() {
    ...
    file = "_app/immutable/components/pages/_layout.svelte-82482edb.js";
    imports = ["_app/immutable/components/pages/_layout.svelte-82482edb.js", "_app/immutable/chunks/index-adf523c1.js"];
    stylesheets = ["_app/immutable/assets/_layout-01d37279.css"];
    fonts = [];
  }
});
...
var Home, GitHubButton, Footer, TvIcon, Header, Page;
var init_page_svelte = __esm({
  ".svelte-kit/output/server/entries/pages/_page.svelte.js"() {
	...
	<div class="${"flex flex-wrap items-center mr-auto"}"><button class="${"w-full md:w-auto text-center bg-pink-600 hover:bg-pink-700 mb-4 flex-none rounded-full text-white font-medium py-3 px-6 mr-8"}">Get recommendations
		...
		<a href="${"https://www.youtube.com/watch?v=Z3LrfdctOpU"}" target="${"_blank"}" class="${"w-full md:w-auto text-center bg-white/20 hover:bg-white/50 mb-4 flex-none rounded-full text-white font-medium py-3 px-6"}">Learn how it&#39;s built
		</a></div></div>`;
    });
    GitHubButton = create_ssr_component(($$result, $$props, $$bindings, slots) => {
      return `<div><a class="${"my-1 flex flex-none items-center py-1 px-4 border border-white/50 rounded-full text-sm bg-white/20 hover:bg-white/50 shadow-sm hover:text-slate-900 text-white"}" href="${"https://github.com/sonnguyentb21/watch-this-web"}" aria-label="${"Star sonnguyentb21/watch-this on GitHub"}"><svg xmlns="${"http://www.w3.org/2000/svg"}" width="${"20"}" height="${"20"}" fill="${"currentColor"}" viewBox="${"0 0 24 24"}"><path d="${"M12 0c-6.626 0-12 5.373-12 12 0 5.302 3.438 9.8 8.207 11.387.599.111.793-.261.793-.577v-2.234c-3.338.726-4.033-1.416-4.033-1.416-.546-1.387-1.333-1.756-1.333-1.756-1.089-.745.083-.729.083-.729 1.205.084 1.839 1.237 1.839 1.237 1.07 1.834 2.807 1.304 3.492.997.107-.775.418-1.305.762-1.604-2.665-.305-5.467-1.334-5.467-5.931 0-1.311.469-2.381 1.236-3.221-.124-.303-.535-1.524.117-3.176 0 0 1.008-.322 3.301 1.23.957-.266 1.983-.399 3.003-.404 1.02.005 2.047.138 3.006.404 2.291-1.552 3.297-1.23 3.297-1.23.653 1.653.242 2.874.118 3.176.77.84 1.235 1.911 1.235 3.221 0 4.609-2.807 5.624-5.479 5.921.43.372.823 1.102.823 2.222v3.293c0 .319.192.694.801.576 4.765-1.589 8.199-6.086 8.199-11.386 0-6.627-5.373-12-12-12z"}"></path></svg>

		<span class="${"ml-2"}">Star on GitHub</span></a></div>`;
    });
    Footer = create_ssr_component(($$result, $$props, $$bindings, slots) => {
      return `<div class="${"max-w-4xl mx-auto w-full flex md:flex-row flex-col items-center md:justify-between py-8 mt-20 border-t border-white/20"}"><div class="${"text-white/70 flex items-center flex-none"}">Powered by <span class="${"mx-1 font-bold"}">OpenAI</span>
		and
		<span class="${"ml-1 font-bold"}">Vercel Edge Functions</span>.
	</div>
	<div class="${"flex items-center mt-2 md:mt-0"}"><a class="${"group"}" aria-label="${"TaxPal on Twitter"}" href="${"https://twitter.com/Sondevml"}"><svg aria-hidden="${"true"}" class="${"mr-4 h-6 w-6 fill-white/50 group-hover:fill-white/70"}"><path d="${"M8.29 20.251c7.547 0 11.675-6.253 11.675-11.675 0-.178 0-.355-.012-.53A8.348 8.348 0 0 0 22 5.92a8.19 8.19 0 0 1-2.357.646 4.118 4.118 0 0 0 1.804-2.27 8.224 8.224 0 0 1-2.605.996 4.107 4.107 0 0 0-6.993 3.743 11.65 11.65 0 0 1-8.457-4.287 4.106 4.106 0 0 0 1.27 5.477A4.073 4.073 0 0 1 2.8 9.713v.052a4.105 4.105 0 0 0 3.292 4.022 4.093 4.093 0 0 1-1.853.07 4.108 4.108 0 0 0 3.834 2.85A8.233 8.233 0 0 1 2 18.407a11.615 11.615 0 0 0 6.29 1.84"}"></path></svg></a>
		${validate_component(GitHubButton, "GitHubButton").$$render($$result, {}, {}, {})}</div></div>`;
    });
    ...
    Header = create_ssr_component(($$result, $$props, $$bindings, slots) => {
      return `<div class="${"max-w-4xl mx-auto w-full flex md:flex-row flex-col items-center md:justify-between py-8 mb-12 border-b border-white/20"}"><button class="${"flex items-center mb-4 md:mb-0 text-white/70"}">${validate_component(TvIcon, "TvIcon").$$render($$result, {}, {}, {})}
		<div class="${"text-2xl md:text-xl font-bold ml-2"}"><a href="${"https://phimmoiy.net/"}">watchthis.dev</a></div></button>
	<a class="${"bg-white/20 hover:bg-white/50 shadow text-white hover:text-pink-600 font-medium rounded p-2 text-sm flex items-center"}" href="${"https://moneylover.me/"}"><span class="${"button_prefix__e8xDo"}"><svg height="${"16"}" viewBox="${"0 0 113 100"}" width="${"16"}" xmlns="${"http://www.w3.org/2000/svg"}"><defs><linearGradient id="${"a"}" x1="${"196.57%"}" x2="${"50%"}" y1="${"228.82%"}" y2="${"50%"}"><stop offset="${"0%"}"></stop><stop offset="${"100%"}" stop-color="${"currentColor"}"></stop></linearGradient></defs><path d="${"M350.5 150L407 250H294z"}" fill="${"url(#a)"}" fill-rule="${"evenodd"}" transform="${"translate(-294 -150)"}"></path></svg></span>
		<span class="${"ml-2"}">Money Lover</span></a></div>`;
    });
    Page = create_ssr_component(($$result, $$props, $$bindings, slots) => {
      ...
      do {
        $$settled = true;
        $$rendered = `<div><div class="${"h-screen w-full bg-cover fixed"}" style="${"background-image: url(/background.png)"}"><div${add_attribute("class", `${""}  flex flex-col items-center justify-center min-h-screen w-full h-full bg-gradient-to-br from-slate-900/80 to-black/90`, 0)}></div></div>
...
var init__3 = __esm({
  ".svelte-kit/output/server/nodes/2.js"() {
    ...
    file3 = "_app/immutable/components/pages/_page.svelte-1ca36a0a.js";
    imports3 = ["_app/immutable/components/pages/_page.svelte-1ca36a0a.js", "_app/immutable/chunks/index-adf523c1.js"];
...
var init_private = __esm({
  ".svelte-kit/output/server/chunks/private.js"() {
    OPENAI_API_KEY = "sk-uTE59FP4ZcacnAyCV7kOT3BlbkFJHWt8JfGFZDqE3KyaCgAmvercel env add CI";
    OMDB_API_KEY = "2771cfe7";
  }
});
...
var manifest = {
  appDir: "_app",
  appPath: "_app",
  assets: /* @__PURE__ */ new Set(["background.png", "favicon.png"]),
  mimeTypes: { ".png": "image/png" },
  _: {
    entry: { "file": "_app/immutable/start-8641b537.js", "imports": ["_app/immutable/start-8641b537.js", "_app/immutable/chunks/index-adf523c1.js", "_app/immutable/chunks/singletons-238905f8.js"], "stylesheets": [], "fonts": [] },
    nodes: [
